        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            {deploy_link && <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img src={deploy} alt="github" className="w-1/2 h-1/2 object-contain" />
            </div>}
          </div>
        </div>
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>Things I have worked on</p>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          links to code repositories and live demos (if available) in it.
        </motion.p>
      </div>
...
const Export = SectionWrapper(Works, "work");
